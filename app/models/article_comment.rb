class ArticleComment < ApplicationRecord
  ...
  has_many :replies, class_name: "ArticleComment", foreign_key: :parent_id, dependent: :destroy # 自己の子供をreplyと名付け、class_name, foreign_keyとともに記述。上記の:parentと合わせて自己結合関連付けが出来る。
